...
- 2026-07-30: Added joint-driven windup/strike/recovery attacks, measured fist momentum, deformable damage and joint breakage, physical fall detection, and repeated floor-contact get-up attempts while the torso remains alive. The controller still exports zero root force and torque throughout recovery. Both fighters are visible, share collision physics, and feed damage/hit feedback into the VR page. Engine: 82 passed, 0 failed, 2 pre-existing grey-robot gaps. Page: 16 passed, 0 failed.
