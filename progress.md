...
- 2026-07-30 Build 8 verification: destroyed elbow/knee/toe joints now return a safe sensor value instead of trapping the page with a stale joint handle while a damaged living torso retries recovery. Engine: 86 passed, 0 failed, 2 pre-existing grey gaps. Page: 16 passed, 0 failed. Flat preview visually shows both grey and red deformable robots, their gauntlets, and the arena with no console error.
